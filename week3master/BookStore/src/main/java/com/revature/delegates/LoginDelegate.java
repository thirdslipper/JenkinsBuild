...
import com.revature.services.CustomerServiceJDBC;
import com.revature.services.EmployeeService;
import com.revature.services.EmployeeServiceJDBC;

public class LoginDelegate implements FrontControllerDelegate {
	private Logger log = Logger.getLogger(LoginDelegate.class);
	private CustomerService cs = new CustomerServiceJDBC();
	private EmployeeService es = new EmployeeServiceJDBC();
