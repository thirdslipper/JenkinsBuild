...
@NamedStoredProcedureQueries({
	@NamedStoredProcedureQuery(name="addBook", procedureName="add_book_to_cart", 
		parameters= {
	...
	@NamedStoredProcedureQuery(name="removeBook", procedureName="remove_book_from_cart",
		parameters= {
				@StoredProcedureParameter(type=Integer.class, mode=ParameterMode.IN),
				@StoredProcedureParameter(type=Integer.class, mode=ParameterMode.IN),
				@StoredProcedureParameter(type=Double.class, mode=ParameterMode.OUT),
	...
	@NamedStoredProcedureQuery(name="emptyCart", procedureName="empty_cart",
	parameters= {
			@StoredProcedureParameter(type=Integer.class, mode=ParameterMode.IN)
	}),
})
