...
public class ListExample {
	...
	private static void linkedListExample() {
		...
		List<Integer> list = (List<Integer>) link;
		Deque<Integer> deque = (Deque<Integer>) link;
		Queue<Integer> queue = (Queue<Integer>) link;
	...
	private static void arrayListExample() {
		...
		// Cannot modify a collection while iterating over it.
		/*for(Integer i : list) {
