...
var users = [
    new user_1.User('rorr', 'pass'),
    new user_1.User('jamarius', 'pass'),
    new user_1.User('seth', 'notpass'),
    new user_1.User('steven', '1234'),
    new user_1.User('collin', 'soul'),
    new user_1.User('joseph', 'design pattern')
];
